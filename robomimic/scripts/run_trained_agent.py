...
def run_trained_agent(args):
    ...
    video_writer = None
    if write_video:
        num_vids = len(os.listdir(args.video_path))
        real_video_path = os.path.join(args.video_path, "video_{}.mp4".format(num_vids))
        video_writer = imageio.get_writer(real_video_path, fps=60)
